...
export default function DisplayNameForm({
  ...
  switch (typeField) {
    ...
    case "phoneNumber":
      ...
      break;
    case "password":
      return <UpdatePassWord setShowModalInfo={setShowModalInfo} />;
      break;
  }
}
...
function UpdateName({ valueField, setReloadUser, setShowModalInfo, uidUser }) {
  ...
  const onSubmit = async () => {
    ...
    const resultCollection = await updateDocument("Users", uidUser, {
      name: newName,
    });
  ...
  return (
    <View style={styles.view}>
      <Text style={styles.textTitle}>Modificar Nombre</Text>
      <Input
...
function UpdateEmail({ valueField, setReloadUser, setShowModalInfo, uidUser }) {
  ...
  const onSubmit = async () => {
    ...
    if (!resultupdateEmail.statusResponse || !resultCollection.statusResponse) {
      setErrorEmail(
        "No se pudo cambiar por este correo, ya se encuentra en uso."
      );
      return;
    }
  ...
  return (
    <View style={styles.view}>
      <Text style={styles.textTitle}>Modificar Correo</Text>
      <Input
        ...
        label="Correo"
        leftIcon={
          <Icon type="font-awesome" name="envelope" iconStyle={styles.icon} />
        }
      />
      <Input
        ...
        leftIcon={
          <Icon type="font-awesome" name="lock" iconStyle={styles.icon} />
        }
        rightIcon={
          <Icon
            type="font-awesome"
...
function UpdatePassWord({ setShowModalInfo }) {
  ...
  const validateForm = () => {
    ...
    if (size(confirmNewPassword) < 6) {
      setErrorConfirmNewPassword(
        "Debes ingresar una confirmacion de contraseña igual a la contraseña."
      );
      isValid = false;
    }
  ...
  return (
    <View style={styles.view}>
      <Text style={styles.textTitle}>Modificar Contraseña</Text>
      <Input
        placeholder="Contraseña actual..."
        containerStyle={styles.input}
...
function UpdatePhone({
  ...
  return (
    <View style={styles.view}>
      <Text style={styles.textTitle}>Modificar Telefono</Text>
...
function UpdateNumberIdentify({
  ...
  const validateForm = () => {
    ...
    if (valueField === numberIdentify) {
      setErrorNumberIdentify(
        "Debes ingresar un numero de identificación diferente al actual."
      );
      isValid = false;
    }
  ...
  return (
    <View style={styles.view}>
      <Text style={styles.textTitle}>Modificar Identificación</Text>
      <Input
        ...
        label="Nro. Identidad"
        leftIcon={
          <Icon type="font-awesome" name="id-badge" iconStyle={styles.icon} />
        }
      />
