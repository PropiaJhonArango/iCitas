    ...
    <ScrollView style={styles.viewContainer}>
      ...
      <View style={styles.viewBody}>
        ...
        <View style={styles.viewBodyButton}>
          <TouchableOpacity style={styles.btnSave} onPress={modifyMember}>
            <Text style={styles.textSave}>Guardar Integrante</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.btnDelete} onPress={askDeleteMember}>
...
function InputPhone({
  ...
  return (
    <View>
      <Text style={styles.textTitle}>Añadir Telefono</Text>
